...
public class SecurityConfiguration {
    ...
    @ConditionalOnProperty(prefix = "app.security", name = "type", havingValue = "db")
    public ServerHttpSecurity buildDefaultHttpSecurity(ServerHttpSecurity http) {
        return http.csrf(ServerHttpSecurity.CsrfSpec::disable).authorizeExchange((auth) -> auth
